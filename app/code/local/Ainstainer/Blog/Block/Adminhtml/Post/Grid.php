...
class Ainstainer_Blog_Block_Adminhtml_Post_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $this->setMassactionIdField('published');
        $this->getMassactionBlock()->setFormFieldName('published');

        $this->getMassactionBlock()->addItem('published', array(
            'label'=> Mage::helper('blog')->__('Change published'),
