...
class Ainstainer_Slider_Block_Adminhtml_Slide_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('slide')->getId()) {
            return Mage::helper('slider')->__("Edit Slide # %s", $this->escapeHtml(Mage::registry('slide')->getId()));
        }
        else {
